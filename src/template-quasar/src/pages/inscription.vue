        ...
        <q-card :style="$q.platform.is.desktop ? 'width:55%;' : ''" class="row my-card items-center q-pa-none q-ma-none shadow-24">
          <q-card-section v-if="$q.platform.is.desktop" class="col-md-4 col-lg-4 col-sm-12 sol-xs-12 items-center float-left" style="background-color: #1f509e"
            ...
            <div class="text-center full-width">
              <div><img src="https://i1.rgstatic.net/ii/profile.image/300101550526464-1448561193179_Q512/Bernard_Tourancheau.jpg" style="width: 33%"/></div>
              <div class="text-weight-bolder text-white text-h6">Osons Sortir</div>
              <div class="text-caption text-white">Réseau social dédiée aux sorties et aux rencontres</div>
            </div>
          </q-card-section>
